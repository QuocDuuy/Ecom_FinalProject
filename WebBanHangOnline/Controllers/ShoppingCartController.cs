...
/*                    var guid = Request.Params["guid"];*/
                    var shoppingCart = Session["Cart"] as ShoppingCart;
        ...
        private Payment CreatePayment(APIContext apiContext, string redirectUrl)
        {
            ...
            Debug.WriteLine($"Total Price from ShoppingCart: {listSanPham.GetTotalPrice()}");
            ...
            {
                Debug.WriteLine($"Item: {item.ProductName}, Quantity: {item.Quantity}, Price: {item.Price}");
       
                itemList.items.Add(new Item()
                {
                    name = item.ProductName,
                    currency = "USD",
                    price = Math.Round(item.Price / 23500,2).ToString(),
            ...
            var details = new Details()
            {
                tax = "0",
                shipping = "0",
                subtotal = listSanPham.GetTotalPrice_USD().ToString()
            };
            //Final amount with details  
            var amount = new Amount()
            {
                currency = "USD",
                total = listSanPham.GetTotalPrice_USD().ToString(), // Total must be equal to sum of tax, shipping and subtotal.  
                details = details
            };
